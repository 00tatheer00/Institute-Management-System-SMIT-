  ...
  return (
    <>
      <section className="relative overflow-hidden bg-[#fcfdfd] dark:bg-slate-950 pt-10 pb-16 md:pt-14 md:pb-20 lg:pt-16 lg:pb-24 border-b border-slate-100 dark:border-slate-850">
        {/* ─── 1. Faded Cyber Grid & Precision Dot Matrix ─── */}
        <div className="hero-faded-grid absolute inset-0 pointer-events-none opacity-70 dark:opacity-35" />
        <div className="hero-faded-dots absolute inset-0 pointer-events-none opacity-80 dark:opacity-30" />

        {/* ─── 2. 2D Particle Constellation Net (Interactive & Lightweight) ─── */}
        ...
        {/* ─── 3. Ambient Radiant Glowing Flare ─── */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[360px] bg-gradient-to-r from-sky-400/15 via-emerald-400/12 to-teal-400/15 rounded-full blur-[90px] pointer-events-none animate-pulse-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[250px] bg-emerald-400/10 rounded-full blur-[80px] pointer-events-none" />

        {/* ─── 4. Animated Doodle Vector Graphics ─── */}

        {/* Top-Left: Laptop Doodle with Mouse */}
        <motion.div
          animate={{ y: [0, -8, 0], rotate: [-0.5, 1, -0.5] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-6 left-6 sm:top-10 sm:left-14 lg:left-24 pointer-events-none select-none z-10"
        >
          <svg
            width="110"
            height="85"
            ...
            className="w-16 h-12 sm:w-24 sm:h-18 lg:w-28 lg:h-22 drop-shadow-sm"
          >
            {/* Screen */}
            <path
            ...
            <path
              ...
              fill="none"
            />
            <ellipse cx="102" cy="76" rx="6" ry="9" stroke="#22c55e" strokeWidth="2.5" fill="rgba(34, 197, 94, 0.12)" />
        ...
        <motion.div
          ...
          className="absolute top-8 right-6 sm:top-12 sm:right-16 lg:right-28 pointer-events-none select-none z-10"
        >
        ...
        {/* Bottom-Left: Ascending Paper Airplane with Curved Dotted Trail */}
        <motion.div
          animate={{ y: [0, -6, 0], x: [0, -4, 0] }}
          transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute bottom-28 left-4 sm:bottom-36 sm:left-14 lg:left-24 pointer-events-none select-none z-10 hidden sm:block"
        >
          <div className="relative">
            <svg
              width="130"
        ...
        {/* Bottom-Right: Stylized Globe on Desk Stand */}
        <motion.div
          animate={{ rotate: [-2, 2, -2] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-24 right-6 sm:bottom-32 sm:right-16 lg:right-28 pointer-events-none select-none z-10 hidden sm:block"
        >
          <svg
            width="90"
            height="110"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="w-16 h-20 sm:w-22 sm:h-28 drop-shadow-sm"
          >
            <path
        ...
        <div className="container-custom relative z-10 max-w-5xl mx-auto text-center space-y-5 sm:space-y-6">
          ...
          <div className="space-y-1 sm:space-y-2">
            ...
            <motion.h2
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-[68px] font-black tracking-tight leading-[1.08]"
            >
              <span className="shimmer-cyan inline-block relative">
                Tech Future
                <span className="absolute -bottom-1.5 left-0 right-0 h-1.5 bg-[#0284c7]/30 rounded-full blur-[1px]" />
              </span>
            </motion.h2>
          </div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-50/90 dark:bg-emerald-950/50 border border-emerald-200/80 dark:border-emerald-800 text-emerald-800 dark:text-emerald-300 shadow-2xs backdrop-blur-xs">
          ...
          >
            <Link href="/admissions">
              <button className="btn-shimmer bg-[#0284c7] hover:bg-[#0369a1] active:scale-95 text-white font-extrabold text-xs sm:text-sm uppercase tracking-wider px-8 py-3.5 rounded-full shadow-lg shadow-[#0284c7]/25 hover:shadow-xl hover:shadow-[#0284c7]/35 hover:-translate-y-0.5 transition-all duration-200">
                ENROLL NOW
              </button>
            </Link>
            <Link href="/courses">
              <button className="bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 active:scale-95 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-700 font-extrabold text-xs sm:text-sm uppercase tracking-wider px-8 py-3.5 rounded-full shadow-2xs hover:shadow-xs transition-all duration-200">
                EXPLORE COURSES
              </button>
            </Link>
          </motion.div>
          ...
          >
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-[32px] bg-[#bfdbfe]/60 dark:bg-sky-950/40 p-4 border border-sky-200/80 dark:border-sky-800/60 shadow-float hover:shadow-lifted hover:-translate-y-1.5 transition-all duration-300">
            ...
            <div
              ...
              className="md:col-span-4 group relative cursor-pointer overflow-hidden rounded-[28px] bg-black border-2 border-slate-800 dark:border-slate-700 shadow-2xl hover:shadow-[#0284c7]/25 hover:-translate-y-2 transition-all duration-300 transform md:-translate-y-2"
            >
              <div className="relative h-72 sm:h-80 w-full overflow-hidden">
                ...
                {/* Red Circular Play Button in Exact Center with Glowing Ripple */}
            ...
            <div className="md:col-span-4 group relative overflow-hidden rounded-[32px] bg-[#fef3c7]/60 dark:bg-amber-950/40 p-4 border border-amber-200/80 dark:border-amber-800/60 shadow-float hover:shadow-lifted hover:-translate-y-1.5 transition-all duration-300">
