...
export function PublicFooter() {
  ...
  const quickLinks = [
    ...
    { label: tNav("trainers"), href: "/trainers" },
    { label: tNav("batches"), href: "/batches" },
    { label: tNav("admissions"), href: "/admissions" },
  ...
  const supportLinks = [
    ...
    { label: tNav("verifyCertificate"), href: "/verify-certificate" },
    { label: tNav("announcements"), href: "/announcements" },
    { label: tNav("gallery"), href: "/gallery" },
    { label: tNav("events"), href: "/events" },
    { label: tNav("successStories"), href: "/success-stories" },
  ];
